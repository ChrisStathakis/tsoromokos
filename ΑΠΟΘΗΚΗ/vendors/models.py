...
class Invoice(models.Model):
    ...
    value = models.DecimalField(decimal_places=DECIMAL_PLACES, max_digits=20, verbose_name='Καθαρή Αξια')
    extra_value = models.DecimalField(decimal_places=DECIMAL_PLACES, max_digits=20, verbose_name='ΜΕΤΑΦΟΡΙΚΑ')
    final_value = models.DecimalField(decimal_places=DECIMAL_PLACES, max_digits=20, verbose_name='Αξία', default=0.00)
    ...
    def save(self, *args, **kwargs):
        ...
        self.final_value = round(Decimal(self.value) + Decimal(self.extra_value) + Decimal(self.taxes_value), 5)
    ...
    def filters_data(request, qs):
        ...
        date_start, date_end, date_range = initial_date(request, 24)
...
class InvoiceItem(models.Model):
    ...
    qty = models.DecimalField(max_digits=17, decimal_places=3, default=1, verbose_name='Ποσότητα')
    value = models.DecimalField(max_digits=17, decimal_places=DECIMAL_PLACES, verbose_name='Τιμή Μοναδας')

    discount = models.DecimalField(max_digits=10, decimal_places=2, default=0, verbose_name='Εκπτωση')
    discount_value = models.DecimalField(max_digits=10, decimal_places=DECIMAL_PLACES, default=0, verbose_name='Ποσο Εκπτωσης')

    clean_value = models.DecimalField(max_digits=17, decimal_places=5, verbose_name='Αξια')
    total_clean_value = models.DecimalField(max_digits=17, decimal_places=5, verbose_name='Καθαρη Αξια')

    taxes_modifier = models.CharField(max_length=1, choices=TAXES_CHOICES, default='c')
    taxes_value = models.DecimalField(max_digits=17, decimal_places=5, verbose_name='Αξια ΦΠΑ')
    extra_value = models.DecimalField(max_digits=17, decimal_places=2, verbose_name='Αξια Μεταφορικων')
    total_value = models.DecimalField(max_digits=17, decimal_places=5, verbose_name='Τελικη Αξία')
    final_value_unit = models.DecimalField(max_digits=17, decimal_places=5, default=0, verbose_name='Τελικη Αξία')
    ...
    def final_value(self):
        return round(self.value * ((100 - self.discount) / 100), 5)
